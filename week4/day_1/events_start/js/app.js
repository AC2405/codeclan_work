...
resultParagrapgh.textContent = "button has definetly been clicked"
}
...
resultParagrapgh.textContent = " Your Name " + event.target.first_name.value + " " + event.target.last_name.value
}