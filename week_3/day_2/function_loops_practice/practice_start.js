...
// console.log(totalNumbers(myNumbers))
    ...
    //   var firstthreenumbers = numbers.splice(0, 3)
...
function searchNumber(numbers, searchnumber){
  for(var number of numbers){
  ...
  //console.log(searchNumber(myNumbers, 16) )
  //console.log(searchNumber(myNumbers, 21))
