...
// 5. Console log only the users that have less than £100
// for(var user of users){
//     if(user.money < 100 == true)
//     console.log(user)
// }

// 6. Console log the users who are under the age of 30 AND have more than £10
// for(user of users){
//     if(user.age < 30 && user.money > 10 === true)
//     console.log(user)
// }
// 7. Console log the users who have a premier account OR at least £100 in their account
// for(var user of users){
//     if(user.account === "premium" || user.money > 100 )
//     console.log(user)
// }

// 8. Change everyone who has a "basic" account to have a "standard" account


// 9. Premium account owners should get a bonus. Add 10 to their money
